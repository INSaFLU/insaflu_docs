...
All reference sequences at INSaFLU  are publicly available at NCBI (or are made available under permission of the authors). Download the current list here: :download:`INSaFLU_current_REFERENCE_DATABASE_11_05_2018.xlsx <_static/INSaFLU_current_REFERENCE_DATABASE_11_05_2018.xlsx>`) 
